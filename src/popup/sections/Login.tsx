    ...
    return (
        <div style={{...EXT_STYLE}} className="dark:bg-dark-mode relative ease-out duration-300">
            <div className="flex min-h-full flex-1">
                <div className="flex flex-1 flex-col justify-center px-4 py-5 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
                        ...
                        <div className="mt-10">
                            <div>
                                <form action="#" method="POST" className="space-y-4">
                                    ...
                                    <Link to={'/signup'}>
                                        <a href="#" className="pt-3 text-sm font-semibold text-indigo-600 hover:text-indigo-500 flex justify-center">
                            ...
                            <div className="mt-6">
                                ...
                                <div className="mt-6 grid grid-cols-2 gap-4">
                                    ...
                                    >
                                        <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" width="800px"
                                             height="800px"
