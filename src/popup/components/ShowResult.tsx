...
function Loading(loading: any) {
    return (
        <div
            className="relative items-center block w-full rounded-2xl bg-white border border-gray-100 shadow-md dark:bg-gray-800 dark:border-gray-800 dark:hover:bg-gray-700">
      <textarea
          rows={8}
          name="comment"
          id="comment"
